...
$mail->Body    = '<body>The incident was uploaded to crimedetect website under the categery Incometax in location '.$u.' with the following description '.$message.'. The image was checked for forgery and hope this can be a crucial evidence for the investigation</body>';
